function expandAdvancedOptions()
{
	 ...
	 document.getElementById("more").innerHTML = 
			'<span class="text">&nbsp;&nbsp; Empirically modeling the relationship between peak and '
...
function selectMappaOption(){
	...
	var sglist= document.getElementById("sglist");
	    ...
	    if(selection.includes("rn")){
			...
			+'</ul>'  
			+'<span class="footnote"> Mappability is only available for hg19 and mm9 </span>'
			+'</div>'
			+'</td>'
			+'</tr>' ;
