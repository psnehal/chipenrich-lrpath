...
<!--  LOGO PANEL -------------------------------------------------------------------------------------------------------------------------->			
		...
		<div id="logoPanel">
			<a href="chipMain.jsp">
			<img height="35%" width="60%" alt="ChipEnrich" src="logos/chipLogo.jpg"></a> <br /> <br /> 
...
<!--  RESULTS PANEL ---------------------------------------------------------------------------------------------------------------------->	
				...
				<div id="contentPanel">
					...
					<div id="textPanel">
					<span class="text">
						This Page is under maintainance.Please check back later.
					</span>
					<div id="textPanel">
                         <span class="text">Encode results can be accessed <a href = "SummaryEncode.jsp">here</a> <br /> <br /> </span>
                 </div>
					</div>
					<hr>
				</div>
